      ...
      <View>
        {userData.map((user, index) => (
          <View
            ...
            <Text style={{color: 'gray', margin: scale(2), fontSize: 12}}>
              Job Branch: {user.jobBranch}
            </Text>
            <Text style={{color: 'gray', margin: scale(2), fontSize: 12}}>
              Job Salary: {user.jobSalary}
            </Text>
            <Text style={{color: 'gray', margin: scale(2), fontSize: 12}}>
              Experiance Required: {user.jobExperiance}
            </Text>
            <Text style={{color: 'gray', margin: scale(2), fontSize: 12}}>
              Status: {user.status}
            </Text>
            <Text style={{color: 'gray', margin: scale(2), fontSize: 12}}>
              User Applied on: {user.userApplieddate}
            </Text>
            <Text
              style={{
                color: 'gray',

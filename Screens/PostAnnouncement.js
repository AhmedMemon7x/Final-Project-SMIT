...
function PostAnnouncement({navigation}) {
  ...
  const createAnnouncement = async () => {
    if (title == '') {
      errorShow('error', 'please enter your title');
    } else if (description == '') {
      errorShow('error', 'please enter your description');
        ...
        <View style={{flex: 1}}>
          ...
          <View
            ...
            <Button
              ...
              mode="contained"
              onPress={() => {
                navigation.navigate('Delete Announcements');
              }}>
              Recent Events
            </Button>
          </View>
